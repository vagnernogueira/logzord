...
> Instruções operacionais consolidadas do projeto. Skills de documentação e geração de demandas são fornecidas pelo mecanismo nativo de skills (xskills) do agente.
